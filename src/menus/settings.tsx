                ...
                <main>
                    ...
                    <div id="theme-card" className="card">
                        ...
                        <div className="card-input">
                            <select className="card-dropdown" id="themeOptions">
                    ...
                    <div id="devtools" className="card">
                        <div className="card-info">
                            ...
                            <div className="card-desc">
                                ...
                                <span className="card-subtitle"> Enables DevTools on Startup. (Changes will take effect on restart.) </span>
                            </div>
                        </div>
...
// Theme stuff, Check FIXME in themeAPI.handler
/*
<div id="theme-card" className="card">
                        <div className="card-info">
                            <svg className="card-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
